...
const Footer = () => {
    ...
    return (
        <footer className="flex flex-col items-center mt-5 justify-between px-6 py-4 bg-gray-100 dark:bg-gray-800 sm:flex-row">
            <a href="#"
            ...
            <div className="flex -mx-2">
                <a href="https://www.facebook.com/bahauddintanvir1" target="_blank"
                ...
                <a href='https://www.github.com/b-tanvir' target="_blank"
                   className="mx-2 text-gray-600 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300"
                   aria-label="Github">
                    <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none"
                         xmlns="http://www.w3.org/2000/svg">
